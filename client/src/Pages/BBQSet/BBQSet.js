  ...
  render() {
    return (
      <div className="App">
        ...
        <h1>The MeatStick Ultimate BBQ Set</h1>
        <div>
          <p>SKU: 860400000716</p>
          <h2>Overview</h2>
          <p>The MeatStick Ultimate BBQ set is the first and only TRUE Wireless Smart Meat Thermometer with a companion WiFi Bridge.</p>
          <p>The MeatStick Ultimate BBQ set includes 2 MeatStick TRUE wireless probes, 1 MeatStick charger, and 1 MeatStick WiFi Bridge. </p>
          ...
          <p>The MeatStick uses a rechargeable battery that charges through the included charger with a microUSB input. The WiFi Bridge has a microUSB input for power. (Cable included) A USB battery pack is recommended (sold separately) </p>

          <h3>WI-FI LINK - EXTEND YOUR RANGE </h3>
          <p>The MeatStick uses Bluetooth to communicate with your phone with a range of up to 30 feet. However, when The MeatStick is enclosed in an oven, grill, smoker, or water (sous vide), the range can be greatly limited depending on the enclosure. Wi-Fi Link allows you to use your extra phone/tablet or WiFi Bridge in range of The MeatStick to transmit the temperature data through your local Wi-Fi or the cloud to your phone. You can then check your temperatures from anywhere!</p>
        </div>
      </div>
    );
  }
