  ...
  render() {
    return (
      <div className="App">
        ...
        <h1>The Meat<span id="yellow">Stick</span> Ultimate BBQ Set</h1>
        <div className="BBQSetDiv">
          <p>SKU: 860400000716</p>
          <h2>Overview</h2>
          <p className="meatstickP">The MeatStick Ultimate BBQ set is the first and only TRUE Wireless Smart Meat Thermometer with a companion WiFi Bridge.</p>
